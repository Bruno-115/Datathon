...
# Define a raiz do projeto (subindo 2 níveis a partir de 'pages/1_dashboard.py')
ROOT_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", ".."))

# Adiciona a raiz do projeto ao sys.path antes dos imports
if ROOT_DIR not in sys.path:
    sys.path.insert(0, ROOT_DIR)

# Agora o import vai funcionar normalmente
from api import graficos as graf

caminho_csv = os.path.join(ROOT_DIR, "api", "dados_tratados.csv")
